"""
DQN training script for Atari DemonAttack.

Main training loop implementing epsilon-greedy exploration, experience replay,
target network updates, and periodic evaluation.
"""
